...
sudo scp -i ../ec2_keypair.pem FriendSocialNetwork.java ubuntu@"$IPV4_ADDRESS":/home/ubuntu
sudo scp -i ../ec2_keypair.pem setup.sh ubuntu@"$IPV4_ADDRESS":/home/ubuntu
sudo scp -i ../ec2_keypair.pem test.txt ubuntu@"$IPV4_ADDRESS":/home/ubuntu